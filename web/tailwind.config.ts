...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        xs: ["1rem", { lineHeight: "1.3" }],
        sm: ["1.1875rem", { lineHeight: "1.45" }],
        base: ["1.3125rem", { lineHeight: "1.6" }],
        lg: ["1.4375rem", { lineHeight: "1.55" }],
        xl: ["1.5625rem", { lineHeight: "1.5" }],
        "display-2xl": ["5.125rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "display-xl": ["4.25rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "display-lg": ["3.375rem", { lineHeight: "1.15", letterSpacing: "-0.01em" }],
        "display-md": ["2.625rem", { lineHeight: "1.2" }],
        "display-sm": ["2.1875rem", { lineHeight: "1.25" }],
