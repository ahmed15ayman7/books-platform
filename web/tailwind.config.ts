...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        xs: ["0.9375rem", { lineHeight: "1.35" }],
        sm: ["1.125rem", { lineHeight: "1.45" }],
        base: ["1.25rem", { lineHeight: "1.6" }],
        lg: ["1.4375rem", { lineHeight: "1.55" }],
        xl: ["1.5625rem", { lineHeight: "1.5" }],
        "2xl": ["1.6875rem", { lineHeight: "1.4" }],
        "3xl": ["2.0625rem", { lineHeight: "1.35" }],
        "4xl": ["2.4375rem", { lineHeight: "1.25" }],
        "5xl": ["3.0625rem", { lineHeight: "1.2" }],
        "6xl": ["3.8125rem", { lineHeight: "1.15" }],
        "7xl": ["4.5625rem", { lineHeight: "1.1" }],
        "8xl": ["6.0625rem", { lineHeight: "1.05" }],
        "9xl": ["8.0625rem", { lineHeight: "1" }],
        "display-2xl": ["5.5rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "display-xl": ["4.5rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "display-lg": ["3.625rem", { lineHeight: "1.15", letterSpacing: "-0.01em" }],
        "display-md": ["2.75rem", { lineHeight: "1.2" }],
        "display-sm": ["2.3125rem", { lineHeight: "1.25" }],
        "display-xs": ["1.8125rem", { lineHeight: "1.3" }],
      },
      spacing: {
        "18": "4.5rem",
        "22": "5.5rem",
