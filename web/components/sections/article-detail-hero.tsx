      ...
      <div className="container-platform relative z-10">
        ...
        >
          ...
          >
            ...
            <h1
              className={cn(
                "font-display text-xl font-bold leading-snug text-[var(--brand-red-hover)] sm:text-2xl md:text-[1.65rem] text-balance",
                isAr ? "pe-2 ps-10 text-right md:ps-12" : "ps-10 pe-2 text-left md:ps-12",
              )}
            >
              {title}
            </h1>
