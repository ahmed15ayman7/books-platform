...
export function CtaBand({
  ...
  return (
    ...
    >
      {quote && (
        <blockquote className="mx-auto max-w-2xl font-display text-xl font-bold text-white md:text-2xl">
          {quote}
        </blockquote>
      )}
      {tagline && (
        <p className="mx-auto mt-4 max-w-xl text-sm text-[var(--brand-gray-400)] md:text-base">
          {tagline}
        </p>
      )}
