              ...
              <li className="relative list-none">
                ...
                <SlideIn from={i % 2 === 0 ? "start" : "end"}>
                  <div className="rounded-xl border border-[var(--brand-gray-200)] bg-white p-5 shadow-sm">
                    <h3 className="text-xl font-bold text-[var(--brand-gray-900)] md:text-2xl">{step.title}</h3>
                    <p className="mt-2 text-lg leading-relaxed text-[var(--brand-gray-700)] md:text-xl">
                      {step.body}
                    </p>
                  </div>
                </SlideIn>
