...
export function ServicesQuoteBand({ quote }: ServicesQuoteBandProps) {
  return (
    <AnimatedSection>
      <div className="rounded-2xl border border-[var(--brand-gray-200)] bg-white px-6 py-12 text-center md:px-10 md:py-14">
        <RevealLines
          lines={[quote]}
          lineClassName="mx-auto max-w-3xl font-display text-2xl font-bold text-[var(--brand-gray-900)] md:text-3xl"
        />
        <FadeIn delay={0.2}>
