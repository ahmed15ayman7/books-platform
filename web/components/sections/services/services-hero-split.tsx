        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            <RevealText
              text={title}
              as="h1"
              className="font-display text-display-lg font-bold text-[var(--brand-gray-900)] block"
            />
            <FadeIn delay={0.2}>
              <p className="mt-4 max-w-xl text-xl leading-relaxed text-[var(--brand-gray-600)] md:text-2xl">
                {subtitle}
              </p>
            </FadeIn>
